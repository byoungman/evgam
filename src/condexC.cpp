...
double condexd0(Rcpp::List pars, arma::mat X1, arma::mat X2, arma::mat X3, arma::mat X4, 
                arma::mat ymat, arma::mat xmat, arma::uvec dupid, int dcate, arma::uvec nhere)
{
...
double y, yi, talpha, tbeta, mu, tsigma;
...
for (int l=0; l < nhere[j]; l++) {
  ...
  sigma2 = sigma * yib;
  res = (y - mu2) / sigma2;
  nllh += 0.5 * logtwopi + log(sigma2) + 0.5 * res * res; 
                ...
                arma::mat ymat, arma::mat xmat, arma::uvec dupid, int dcate, arma::uvec nhere)
{
  ...
  for (int j=0; j < nobs; j++) {
    ...
    for (int l=0; l < nhere[j]; l++) {
      ...
      out(j, 0) += -(2 * (ee36 * ee6 * ee14/ee23));
      out(j, 1) += (ee21 * ee14/ee7 - 1) * ee1 * ee17;
      out(j, 2) += -(ee14/(ee4 * ee16));
      out(j, 3) += 1 - ee30/ee10;
      out(j, 4) += (4 * (R_pow(yi, ee26) * ee6/ee19) + ee36 * (2 -
        4 * (ee6/ee8)) * ee14) * ee6/ee23;
      out(j, 5) += -(yi * (2 * (ee14/ee10) + 2 * (R_pow(yi, (ee1 -
        1)) * ee21/ee3)) * ee6 * ee1 * ee17/ee19);
      out(j, 6) += 2 * (ee9 * ee6/ee23);
      out(j, 7) += 4 * (yi * ee6 * ee14/(ee19 * ee10));
      out(j, 8) += ((((2 * (ee29 * ee14/ee10) + ee33) * ee1 * ee17 +
        ee14 * ee27) * ee3/ee10 + mu * (ee27/ee7 + ee18 * ee1 * ee3 *
        ee17/ee10)) * ee14/ee7 + (R_pow(ee21, 2) - ee35) * ee1 *
        ee17 - ee27/ee4) * ee1 * ee17;
      out(j, 9) += (((1/ee3 - ee18 * ee3/ee10)/ee4 - ee7/ee10) * ee14 -
        ee20) * ee1 * ee17/ee3;
      out(j, 10) += ((((ee14 * ee34 - ee33)/ee4 - ee7 * ee21) * ee14 +
        ee22)/ee10 - 1) * ee1 * ee17;
      out(j, 11) += 1/ee16;
      out(j, 12) += ee14 * (ee4 + R_pow(yi, (ee15 + ee1 - 1)))/ee10;
      out(j, 13) += 1 - ((ee34/ee4 - ee35) * ee30 + ee22)/ee10;
                ...
                arma::mat ymat, arma::mat xmat, arma::uvec dupid, int dcate, arma::uvec nhere)
{
  ...
  for (int j=0; j < nobs; j++) {
    ...
    for (int l=0; l < nhere[j]; l++) {
      ...
      out(j, 0) += -((ee53 * (2 * ee79 + 4 * ee79) * ee8/ee26 + R_pow(yi, (ee42 -
        1)) * (2 - ((4 * (1 + 2 * ee8) + 4 * ee10 - 16 *
        ee8)/ee10 + 4) * ee8/ee10) * ee17) * ee8/ee65);
      out(j, 1) += yi * ((ee17/ee6 + R_pow(yi, (ee1 - 1)) * ee32/ee4) *
        ee53 + 8 * (ee77/ee40)) * ee8 * ee1 * ee9/ee26;
      out(j, 2) += -(ee12 * ee53 * ee8/ee65);
      out(j, 3) += -(yi * (2 * (ee53 * ee17) + 8 * (ee77/ee26)) * ee8/
        ee40);
      out(j, 4) += -(((4 * ee39 * ee1 * ee4 * ee9 * ee32 + ee12 * (2 *
        ee23 + 4 * (ee24 * ee1 * ee13 * ee9/ee6)) * ee17)/ee6 +
        2 * (ee12 * ee48/ee4)) * ee8 * ee1 * ee9/ee26);
      out(j, 5) += -((2 * (ee12 * ee52/ee4) - 2 * (ee39/ee6)) * ee8 *
        ee1 * ee9/ee26);
      out(j, 6) += -(((ee70 - 2 * ee82) * ee17 + 2 * (ee12 * ee58) -
        2 * (ee39 * ee4 * ee32)) * ee8 * ee1 * ee9/ee40);
      out(j, 7) += 0;
      out(j, 8) += -((ee59 + 2 * R_pow(yi, (ee11 + ee1))) * ee8/ee40);
      out(j, 9) += (ee70 + 2 * (ee12 * ee38) - 4 * ee82) * ee8 * ee17/
        ee40;
      out(j, 10) += ((((((2 * (ee3 * (ee63 - ee44 * ee9)) + 8 * (ee54 *
          ...
          ee6 + mu * ee34 * ee23) * ee1 * ee9 + ee17 * ee62) * ee4/
            ee6 + mu * (ee69 * ee1 * ee4 * ee9/ee6 + ee62/ee5)) * ee17/
              ee5 + (3 * (ee48 * ee32) - ee69 * ee13/ee6) * ee1 * ee9 - ee62/
                ee3) * ee1 * ee9;
      out(j, 11) += ((((ee60 * ee1 * ee9 - ee63) * ee4/ee6 + ee41) *
        ee17/ee3 - ee48)/ee4 + 2 * (ee67 * ee32)) * ee1 * ee9;
      out(j, 12) += ((((ee74 * (1 - 2 * (ee18 * ee13/ee6)) + (ee75 +
      ...
      out(j, 13) += -(2 * (ee67/ee4));
      out(j, 14) += -(((ee60/ee3 + ee4 * (ee3 * ee52 - 2 * (ee24 *
        ee4/ee6)) + ee3) * ee17 - (ee27 + ee45 * ee32)) * ee1 * ee9/
          ee6);
      out(j, 15) += ((((ee17 * ee78 - mu * ee64)/ee3 - (ee32 * ee38 +
        2 * (ee3 * ee58 * ee4/ee6)) * ee4) * ee17 + ee71)/ee6 - 1) *
        ee1 * ee9;
      out(j, 16) += 0;
      out(j, 17) += -(2 * (ee18/ee6));
      out(j, 18) += (ee64/ee3 + ee3 - (ee75 + ee24 + ee24) * ee13/
        ee6) * ee17/ee6;
      out(j, 19) += 1 - ((ee78/ee3 - ee34 * ee13 * ee38/ee6) * R_pow(ee17, 2) +
        ee71)/ee6;
