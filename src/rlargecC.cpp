...
//   
//   double mu, lpsi, txi, xi;
//   arma::rowvec y(r + drop);
//   
//   double ee2, ee3, ee5, ee6, ee7, ee8, ee9;
//   double ee11, ee13, ee14, ee15, ee16, ee17, ee18, ee19;
