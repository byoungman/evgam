...
aggaussd0 <- function(pars, X1, X2, X3, X4, ymat, wmat, dupid, dcate, nhere, C, epsilon = 0.1) {
    .Call(`_evgam_aggaussd0`, pars, X1, X2, X3, X4, ymat, wmat, dupid, dcate, nhere, C, epsilon)
}

aggaussd12 <- function(pars, X1, X2, X3, X4, ymat, wmat, dupid, dcate, nhere, C, epsilon = 0.1) {
    .Call(`_evgam_aggaussd12`, pars, X1, X2, X3, X4, ymat, wmat, dupid, dcate, nhere, C, epsilon)
}

aggaussd34 <- function(pars, X1, X2, X3, X4, ymat, wmat, dupid, dcate, nhere, C, epsilon = 0.1) {
    .Call(`_evgam_aggaussd34`, pars, X1, X2, X3, X4, ymat, wmat, dupid, dcate, nhere, C, epsilon)
}
...
condexaggd12 <- function(pars, X1, X2, X3, X4, X5, X6, ymat, xmat, wmat, dupid, dcate, nhere, C, epsilon = 0.1) {
    .Call(`_evgam_condexaggd12`, pars, X1, X2, X3, X4, X5, X6, ymat, xmat, wmat, dupid, dcate, nhere, C, epsilon)
}

condexaggd34 <- function(pars, X1, X2, X3, X4, X5, X6, ymat, xmat, wmat, dupid, dcate, nhere, C, epsilon = 0.1) {
    .Call(`_evgam_condexaggd34`, pars, X1, X2, X3, X4, X5, X6, ymat, xmat, wmat, dupid, dcate, nhere, C, epsilon)
}
