...
egpd1d12 <- function(pars, X1, X2, X3, y, dupid, duplicate) {
  ...
  # second derivatives
  out[, 4] <- x * (.e70 * .e11/.e1 + (.e10 * (xi * (.e80/.e63 + .e69/.e1) * 
            .e12 * .e6 - ((.e76/.e10 + x * .e65 * .e14/(.e5^(.e6 + 
            .e20) * .e1))/.e1 + (.e35 - 2 * (.e31 * .e83)) * 
            .e16/.e74) * .e11) - xi * .e54 * .e6 * .e7/.e1)/.e12) # d11
  out[, 5] <- x * (((((((.e23 - .e31 * .e7)/.e73 + (xi * .e28 * 
...
egpd1d34 <- function(pars, X1, X2, X3, y, dupid, duplicate) {
  ...
  .e120 <- .e114 * .e62
  .e123 <- .e5^.e111
  .e127 <- x * (1/.e115 + .e1 * .e38/.e64) - .e105 * .e11/.e67
  ...
  .e156 <- .e19 + .e66
  .e161 <- .e148 + x * (1/.e21 - .e107 * .e1 * .e77/.e56)
  .e163 <- x * (.e6 * .e1 * .e77/.e56 + 2/.e144) - .e151 * .e11/.e79
  .e164 <- .e15 * .e127
  .e165 <- .e142 * .e1
  .e166 <- 1 + .e18
  .e167 <- xi * .e123
  ...
  .e265 <- .e5^(1 + .e31)
  .e267 <- .e1^2
  .e270 <- x * (.e258 - .e250)/.e1 - (.e11 * (.e36 - .e249/xi) + .e254)/xi
  .e271 <- .e57 * .e98
  .e272 <- .e5^(.e4 - .e166)
  .e273 <- xi * .e87
  .e274 <- xi * .e15
  ...
  .e342 <- .e98 * .e11/.e16 + x * .e83/.e276
  .e343 <- .e10 * .e14
  .e345 <- .e10 * .e256 - .e281 * .e6 * .e7/.e1
  .e348 <- .e62 * .e11/.e16 + x * .e272 * .e60/.e1
  .e349 <- .e5^(.e4 + .e18)
  .e350 <- 2 * .e15
  .e351 <- 2 * .e17
  .e352 <- .e314 + .e27
  ...
  .e396 <- .e304 * .e33
  .e397 <- .e306 * .e48
  .e398 <- (.e339 + x * ((.e10 + .e343 * .e11)/xi - (.e10 + .e315) * .e14)) * .e6
  .e399 <- .e165^2
  .e400 <- .e309 * .e57
  .e401 <- .e345 * .e57
  .e406 <- .e109 * .e46 * .e13
  ...
  .e471 <- x * (.e109 * .e14 - .e10/xi)
  .e473 <- x * (.e6 * (.e352 - .e29) - .e250)/.e1
  .e476 <- x * (.e14 * .e38 - .e10/.e16)/.e1 - ((.e11 * (.e74 - (.e73/xi + .e351)/xi) + .e71/.e1)/.e16 + 2 * (.e17 * .e267 * .e77^2/.e56))
  .e480 <- x * .e310 * .e63/.e1 - 2 * (.e69 * .e11/.e16)
  .e483 <- .e2 * .e310 * .e63/.e1
  .e484 <- x/(.e5 * .e1)
  .e485 <- xi * .e237
  .e486 <- xi * .e241
  ...
  # third derivatives
  out[, 1] <- x * ((.e10 * (xi * ((.e410/.e56 - 
        (.e62 + .e2 * .e272 * .e60/.e1)/.e1) * .e19 - x * .e137 * 
        .e15 * .e12/.e25) * .e6 - (((.e50 + .e42 * (2 * .e483 - 
        2 * .e69)) * .e15 - .e147 * (.e469 + .e202/.e25))/.e92 + 
        (x * (.e497/.e10 + .e354 * .e53/.e1 - ((.e46/.e142 + 
            x * .e257 * .e44/(.e5^(2 + .e18 + .e31) * .e1))/.e1 + 
            (.e165 - .e2 * .e132 * .e349) * .e46/.e399) * .e13) - 
            .e178)/.e1) * .e12) - .e107 * (x * (2 * (.e7 * .e256) - 
        .e84 * .e22/.e1) - .e84 * .e7)/.e1)/.e19 + .e12 * (x * 
        (.e401/.e10 + .e416 - .e383) - .e242)/.e1) #d111
  out[, 2] <- x * 
        ((((((((.e10 - 2 * (.e104^2 * .e10/.e64)) * .e1 + .e42 * 
            (.e27 - .e7))/.e64 + (.e49 + xi * (x * (xi * ((2 * 
            (xi * .e5^(.e100 - 2)/.e67) - .e108 * .e20) * .e11 - 
            .e108)/.e67 - .e6 * .e62)/.e1 - .e116/.e67))/.e1) * 
            .e15 - .e13 * (x * (.e375/.e10 + .e286/.e10)/.e1 - 
            .e104 * .e46 * .e48/.e64))/.e43 + (x * (.e378/.e10 + 
            .e287/.e10 + xi * (.e15 * .e62 * .e55/.e1 + xi * 
            (.e152 * .e7 + (2 * (.e510 * .e123/.e82) - (.e15 * 
                .e22 + .e59/.e5)) * .e48/.e1)/.e82) * .e6) + 
            .e508 * (x * .e174 * .e7 - .e419 * .e48)/.e82 - .e180)/.e1) * 
            .e12 - (.e410 * .e6/.e56 + (.e149 + .e16 * (x * (xi * 
            ((2 * (xi^5 * .e6 * .e123/.e79) - .e22) * .e11 - 
                .e96) * .e6/.e79 - .e343/.e465)/.e1 - .e107 * 
            .e7 * .e11/.e79))/.e1) * .e19) * .e10 - .e107 * (x * 
            (2 * (.e235 * .e7) - .e90 * .e22/.e1) - .e90 * .e7)/.e1)/.e19 + 
            .e12 * (x * (.e356/.e10 + .e358 - .e388) - .e245)/.e1) #d112
  out[, 3] <- -(x * (x * ((.e400/.e10 + .e415 - .e386) * .e12 - 
  ...
  out[, 7] <- (((((((.e438 * .e33 + .e46 * .e48 * 
        ...
        .e33) * .e13 + .e15 * (x * ((.e270/xi - 2 * (.e10 * .e267 * 
        ...
        .e19 * (x * ((.e6 * .e476 - .e77/.e16)/.e56 - 2 * (xi * 
  ...
  out[, 8] <- -((((((((.e396/.e39 - .e337 * 
        ...
        (.e123 + xi * (x * .e111 * .e455/.e1 - 3 * (.e123 * .e11/.e16))) * 
